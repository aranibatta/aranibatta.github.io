function theme(){"rgb(255, 255, 255)"===data?(sessionStorage.setItem("bg","rgb(254, 243, 161)"),sessionStorage.setItem("cc","#777"),document.location.reload()):null==data?(sessionStorage.setItem("bg","rgb(254, 243, 161)"),sessionStorage.setItem("cc","#777"),document.location.reload()):"rgb(254, 243, 161)"===data&&(sessionStorage.setItem("bg","rgb(255, 255, 255)"),sessionStorage.setItem("cc","#333"),document.location.reload())}var data=sessionStorage.getItem("bg"),color=sessionStorage.getItem("cc");
